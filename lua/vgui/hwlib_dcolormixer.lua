...
function PANEL:Init()
	...
	self.Palette.OnRightClickButton = function( ctrl, btn )
		local m = vgui.Create( 'hwLib_DMenu' )
	...
	self.txtR:SetTextColor( hwLib_GetColor( 'vgui_text' ) )
	self.txtR:SetFont( 'hwLib_Montserrat_Medium_16' )
	self.txtR.Paint = function( self, w, h )

		draw.RoundedBox( 3, 0, 0, w, h, hwLib_GetColor( 'vgui_dcolormixer_wangsbg' ) )
	...
	self.txtG:SetTextColor( hwLib_GetColor( 'vgui_text' ) )
	self.txtG:SetFont( 'hwLib_Montserrat_Medium_16' )
	self.txtG.Paint = function( self, w, h )
	...
	self.txtB:SetTextColor( hwLib_GetColor( 'vgui_text' ) )
	self.txtB:SetFont( 'hwLib_Montserrat_Medium_16' )
	self.txtB.Paint = function( self, w, h )
	...
	self.txtA:SetTextColor( hwLib_GetColor( 'vgui_text' ) )
	self.txtA:SetFont( 'hwLib_Montserrat_Medium_16' )
	self.txtA.Paint = function( self, w, h )
...
derma.DefineControl( "hwLib_DColorMixer", "", PANEL, "DPanel" )