...
function PANEL:AddOption( strText, funcFunction )
	...
	local pnl = vgui.Create( "hwLib_DMenuOption", self )
	pnl:SetMenu( self )
	pnl:SetText( strText )
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox( 3, 0, 0, w, h, hwLib_GetColor( 'vgui_dmenu_outline' ) )
	draw.RoundedBox( 3, 1, 1, w - 2, h - 2, hwLib_GetColor( 'vgui_dmenu_bg' ) )
	return true
...
function PANEL:GenerateExample( ClassName, PropertySheet, Width, Height )
	...
	ctrl.DoClick = function()
		local menu = vgui.Create( 'hwLib_DMenu' )
...
derma.DefineControl( "hwLib_DMenu", "A Menu", PANEL, "DScrollPanel" )
